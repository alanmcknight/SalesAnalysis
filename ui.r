...
navbarPage(
    ...
    tabPanel('Apricot Sales Performance',   
             ...
             mainPanel(
               ...
               selectizeInput("dataset3", "Select data breakdown criteria", choices = c("Age", "Age.Range", "Apricot.Position", "BTXDatecreated", "BTXExec", "BTXDtraised", "BTXInsurer", "BTXPolref", "BTXPoltype", "BTXTrantype", "Cancellation", "Day.of.Week.Created", "Do.you.normally.pay.for.your.insurance.monthly.", "Drivers.to.be.insured.", "ECWebref", "Email.Domain", "Employment.Status", "Executive", "Have.you.been.regularly.driving.a.car.not.insured.by.you.", "How.many.years.claim.free.driving.do.you.have.on.the.car.not.insured.by.you.", "How.many.years.no.claims.bonus..NCB..do.you.have.",  "Licence.Years", "Price.Returned.Range", "Postcode.Area", "Postcode.Region", "Proposer.Claims.Count", "Proposer.Convictions.Count", "Quote.Date", "Quote.Day", "Quote.Hour", "Quote.Reference", "Source","SOURCE.TYPE.y", "TrafficCost", "Type.of.driving.licence", "Vehicle.Value.Range", "Vehicle.Year.of.Manufacture", "Voluntary.excess.", "What.is.the.estimated.value.of.the.vehicle.", "What.type.of.cover.would.you.like."),
